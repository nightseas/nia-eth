// ---------------------------------------------------------------------------
// File        : tu03_pktgen_dual_top.sv
// Description : The device top of the two cage 100GAUI-1 image. Instantiates the host
//               bridge, decodes the aperture into two generator blocks and one command
//               block, and carries the segmented instrument and the control plane.
